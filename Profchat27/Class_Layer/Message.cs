...
namespace Class_Layer
{
    public class Message
    {
        ...
        private Message(int id, string text, int roomID, int userID, DateTime sendOn)
        {
            this.ID = id;
            this.Text = text;
            this.RoomID = roomID;
        ...
        public static List<Message> GetList(int roomid)
        {
            ...
            DataTable dt = Database_Layer.ChatDatabase.RetrieveQuery("SELECT * FROM Messages WHERE ChatroomID = " + roomid);
